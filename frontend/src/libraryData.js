...
function filterLibraryIcons(icons = [], filters = {}) {
...
function createLibrarySummary({ resultCount = 0, totalCount = 0, category = 'all', kind = 'all', query = '' }) {
...
async function fetchLibraryIcons(fetchImpl = fetch) {
